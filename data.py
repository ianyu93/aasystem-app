...
EfficientFrontier(table=table[:21], name="pred1")
EfficientFrontier(table=table2[:21], name="true1")
EfficientFrontier(table=table[21:42], name="pred2")
EfficientFrontier(table=table2[21:42], name="true2")
EfficientFrontier(table=table[43:63], name="pred3")
EfficientFrontier(table=table2[43:63], name="true3")